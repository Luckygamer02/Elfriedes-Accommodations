...
const data = [
    ...
    {
        image: "https://images.unsplash.com/photo-1582721478779-0ae163c05a60?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80",
...
function Card({image, title}: CardProps) {
    return (
        <Paper shadow="md" p="xl" radius="md" style={{backgroundImage: `url(${image})`, height: 250}}
